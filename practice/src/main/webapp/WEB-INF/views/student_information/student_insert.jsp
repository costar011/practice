...
<div class="row">
	...
	<div class="col-md-8">
		...
		<form action="/studentt/studentInsert">


			<br> <br> <input type="text" class="form-control" id="name"
				name="name" placeholder="NAME"> <br> <br> <input
				type="text" class="form-control" id="mobile" name="mobile"
				placeholder="MOBILE"> <br> <br> <input type="text"
				class="form-control" id="mobile2" name="mobile2"
				placeholder="MOBILE2"> <br> <br> <input
